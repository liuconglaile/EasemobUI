...
- (instancetype)initWithBodyClass:(Class)bodyClass extendClass:(Class)extendClass reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _avatarImgv = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, _avatarView.frame.size.width, _avatarView.frame.size.height)];
        [_avatarView addSubview:_avatarImgv];
