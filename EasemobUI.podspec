...
s.name         = "EasemobUI"
s.version      = "0.2.6"
s.summary      = "Easemob的UI  在开源库https://github.com/AwakenDragon/EaseMobDIYUI的基础上做的小修改"
...
s.homepage     = "https://github.com/Toylar/EasemobUI"
...
# ――― Author Metadata  ――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
s.author               = { "Xiaohui Li" => "rxhh@me.com" }
# s.authors            = { "周玉震" => "" }
...
# ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
s.source       = { :git => "https://github.com/Toylar/EasemobUI.git", :tag => s.version.to_s }
